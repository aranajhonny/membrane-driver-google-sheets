...
function indexHtml(membraneAuthUrl: string, customAuthUrl: string) {
  ...
  <div style="display: flex; flex-direction: row; justify-content: space-around; align-items: center;">
    <section style="flex: 1; justify-content: space-between; align-items: center;">
      ...
      <p>Use Membrane's Google Sheets integration to sign-in. This is the recommended method.</p>
    ...
    <section style="flex: 1; justify-content: center; align-items: center;">
      ...
      ${
        state.clientId && state.clientSecret
          ...
          : "<p>Client ID and Secret <b>not configured</b>.</p> <p>Invoke <code>:configure</code> with your Google Sheets API Key and Secret to authenticate</p>"
      }
    </section>
  </div>
  `);
